...
const MentionsLegales: React.FC = () => {
  return (
    <div className="container mx-auto px-4 py-10">
      ...
      <section className="mb-6">
        <h2 className="text-2xl font-semibold mb-4">2. Propriété intellectuelle et contrefaçons</h2>
        <p>
      ...
      <section className="mb-6">
        <h2 className="text-2xl font-semibold mb-4">4. Gestion des données personnelles</h2>
        <p>
      ...
      <section className="mb-6">
        <h2 className="text-2xl font-semibold mb-4">8. Lexique</h2>
        <ul className="list-disc ml-6">
